...
def parse_args():
    ...
    parser.add_argument('--name', default='fin_ls_normal',
    ...
    parser.add_argument('--output_dir', default='/content/drive/MyDrive/ass4/outputs_isic', help='ouput dir')
...
def main():
    ...
    model = archs.__dict__[config['arch']](
        ...
        img_size=config['input_h'],  # Use input_h (assuming input_w is the same)
        embed_dims=config['input_list'],
        no_kan=config['no_kan']
        # You might want to pass other relevant args from config too if needed by UKAN init
    )
    ...
    if config['dataset'] == 'Lumbar_Spine':
        ...
        sample_idx = 69  # Or any other index you deem appropriate
